module.exports = ({
    ...
    $description[
        $addField[Verification System;
            ...
            Logging channel: $replaceText[$replaceText[$checkCondition[$getServerVar[verifylogchannel]==undefined];true;❌ \`$getServerVar[prefix]set-logs <channel>\`];false;<#$getServerVar[verifylogchannel]>]
...
Color - $splitContent[$getServerVar[leaveColor];1;undefined;\`$getServerVar[prefix]leavecolor help\`]
...
Color - $splitContent[$getServerVar[joinColor];1;undefined;\`$getServerVar[prefix]joincolor help\`]
